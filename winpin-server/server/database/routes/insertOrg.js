    ...
    return function(req, res) {
       ibmdb.open(connString, function(err, conn) {
			...
			{	console.log("Inside Insert DB");
				...
				conn.query(`INSERT INTO EVENTS (EVENT_NAME,EVENT_DESCRIPTION,EVENT_DATE,EVENT_PASSCODE,EVENT_URL,EVENT_STATUS,ISDELETED,USERID) VALUES('${req.body.eventName}','${req.body.eventDescription}','2020-12-31','${req.body.passcode}','',1, 0, IDENTITY_VAL_LOCAL());`, 
